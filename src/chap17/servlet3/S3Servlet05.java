...
public class S3Servlet05 extends HttpServlet {
    ...
    public void init() throws ServletException {
    	...
    	// Web.xml에 init-param에 있는 정보를 받아옴. ()안에 init-param의 param-name을 적으면 됨.
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		String v1 = getInitParameter("param1");// Web.xml에 init-param에 있는 정보를 받아옴. ()안에 init-param의 param-name을 적으면 됨.
